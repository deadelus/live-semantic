...
import (
	...
	"live-semantic/internal/transport/api"
	"live-semantic/internal/transport/cli"
	"live-semantic/internal/transport/cmd"
	"live-semantic/internal/transport/websocket"
	"os"
	"runtime"
	"syscall"
	"time"
